...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Fetch branch/subject data from branch.json
    function fetchBranchData() {
        fetch('./branch.json')
            ...
            .catch(error => {
                ...
                showMessage('Failed to load course data. Please try again later.', 'error');
            });
    }
    ...
    function fetchStudents() {
        fetch('http://localhost:3000/api/students')
            ...
            .catch(error => {
                ...
                showMessage('Failed to load student data. Please try again later.', 'error');
            });
    }
    ...
    function populateSemesterDropdown() {
        ...
        const semesters = branchData[programKey] ? Object.keys(branchData[programKey]) : [];
